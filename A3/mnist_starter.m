function mnist_starter()
    ...
    net.layers{end+1} = struct('type', 'convolution', ...
        'params', struct('weights', randn(5,5,1,16)/sqrt(5*5*3/2), ...
        'biases', zeros(16,1)), ...
        'padding', [2 2]);
    ...
    net.layers{end+1} = struct('type', 'convolution', ...
        'params', struct('weights', randn(5,5,16,16)/sqrt(5*5*16/2), ...
        'biases', zeros(16,1)), ...
        'padding', [2 2]);
    ...
    % For the fully connected layer, the examples given have sizes
    ...
    net.layers{end+1} = struct('type', 'fully_connected',...
        'params', struct('weights', randn(10,784)/sqrt(784/2), ...
        'biases', zeros(10,1)));
...
%     net = training(net, x_train, y_train, x_val, y_val, training_opts);
    ...
    save('network_trained_with_momentum2.mat', 'net');
